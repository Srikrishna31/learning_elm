			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('https://elm-in-action.com/1.jpeg')
							]),
						_List_Nil),
						A2(
						$elm$html$Html$img,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('https://elm-in-action.com/2.jpeg')
							]),
						_List_Nil),
						A2(
						$elm$html$Html$img,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('https://elm-in-action.com/3.jpeg')
							]),
						_List_Nil)
					]))
			]));
