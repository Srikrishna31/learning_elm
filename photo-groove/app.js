...
_Platform_export({'PhotoGroove':{'init':$author$project$PhotoGroove$main($elm$json$Json$Decode$float)({"versions":{"elm":"0.19.1"},"types":{"message":"PhotoGroove.Msg","aliases":{"PhotoGroove.Photo":{"args":[],"type":"{ url : String.String, size : Basics.Int, title : String.String }"}},"unions":{"PhotoGroove.Msg":{"args":[],"tags":{"ClickedPhoto":["String.String"],"ClickedSize":["PhotoGroove.ThumbnailSize"],"ClickedSurpriseMe":[],"GotRandomPhoto":["PhotoGroove.Photo"],"GotActivity":["String.String"],"GotPhotos":["Result.Result Http.Error (List.List PhotoGroove.Photo)"],"SlidHue":["Basics.Int"],"SlidRipple":["Basics.Int"],"SlidNoise":["Basics.Int"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"PhotoGroove.ThumbnailSize":{"args":[],"tags":{"Small":[],"Medium":[],"Large":[]}}}}})}});}(this));