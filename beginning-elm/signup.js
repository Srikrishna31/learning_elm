...
var $author$project$Signup$main = $elm$browser$Browser$sandbox(
	{
		...
		view: function (model) {
			return $rtfeldman$elm_css$Html$Styled$toUnstyled(
				$author$project$Signup$view(model));
		}
	});
_Platform_export({'Signup':{'init':$author$project$Signup$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Signup.Msg","aliases":{},"unions":{"Signup.Msg":{"args":[],"tags":{"Dummy":[]}}}}})}});}(this));