		...
		switch (msg.$) {
			case 'MsgSurprise':
				return _Utils_update(
					model,
					{
						message: 'Happy Birthday !!' + (A2($elm$core$Maybe$withDefault, '', model.firstname) + ($elm$core$String$fromInt(
							A2($elm$core$Maybe$withDefault, 0, model.age)) + ' years !!'))
					});
			case 'MsgReset':
			...
			default:
				var newAge = msg.a;
				var _v1 = $elm$core$String$toInt(newAge);
				if (_v1.$ === 'Just') {
					var anInt = _v1.a;
					return _Utils_update(
						model,
