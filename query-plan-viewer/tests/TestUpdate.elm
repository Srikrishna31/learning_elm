...
fuzz : (msg -> model -> ( model, cmd )) -> Fuzzer msg -> model -> String -> (model -> Expectation) -> Test
fuzz update =
    fuzzBasic (\msg model -> Tuple.first (update msg model))


fuzzBasic : (msg -> model -> model) -> Fuzzer msg -> model -> String -> (model -> Expectation) -> Test
fuzzBasic update msgFuzzer model description verify =
    Test.fuzz (Fuzz.list msgFuzzer) description <| test update model verify


test : (msg -> model -> model) -> model -> (model -> Expectation) -> List msg -> Expectation
...
testUpdateHelp : Expectation -> (msg -> model -> model) -> model -> (model -> Expectation) -> List msg -> Expectation
