...
var $author$project$Main$darkColors = {
	aL: A3($mdgriffith$elm_ui$Element$rgb255, 180, 180, 180),
	O: A3($mdgriffith$elm_ui$Element$rgb255, 255, 171, 0),
	av: A3($mdgriffith$elm_ui$Element$rgb255, 198, 124, 0),
	af: A3($mdgriffith$elm_ui$Element$rgb255, 255, 221, 75),
	aR: A3($mdgriffith$elm_ui$Element$rgb255, 62, 39, 35),
	ag: A3($mdgriffith$elm_ui$Element$rgb255, 27, 0, 0),
	aS: A3($mdgriffith$elm_ui$Element$rgb255, 106, 79, 75),
	aX: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0),
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ba: fragment, be: host, br: path, bt: port_, bw: protocol, bx: query};
	});
...
var $elm$browser$Browser$sandbox = function (impl) {
	return _Browser_element(
		{
			cx: function (_v0) {
				return _Utils_Tuple2(impl.cx, $elm$core$Platform$Cmd$none);
			},
			c7: function (_v1) {
...
var $author$project$Main$lightColors = {
	aL: A3($mdgriffith$elm_ui$Element$rgb255, 180, 180, 180),
	O: A3($mdgriffith$elm_ui$Element$rgb255, 62, 39, 35),
	av: A3($mdgriffith$elm_ui$Element$rgb255, 27, 0, 0),
	af: A3($mdgriffith$elm_ui$Element$rgb255, 106, 79, 75),
	aR: A3($mdgriffith$elm_ui$Element$rgb255, 255, 171, 0),
	ag: A3($mdgriffith$elm_ui$Element$rgb255, 198, 124, 0),
	aS: A3($mdgriffith$elm_ui$Element$rgb255, 255, 221, 75),
	aX: A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255),
	ay: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0)
};
var $author$project$Main$update = F2(
	function (_v0, model) {
		return _Utils_eq(model.O, $author$project$Main$darkColors.O) ? $author$project$Main$lightColors : $author$project$Main$darkColors;
	});
...
var $mdgriffith$elm_ui$Internal$Style$classes = {bN: 'a', aC: 'atv', bP: 'ab', bQ: 'cx', bR: 'cy', bS: 'acb', bT: 'accx', bU: 'accy', bV: 'acr', a0: 'al', a1: 'ar', bW: 'at', aD: 'ah', aE: 'av', bY: 's', b0: 'bh', b1: 'b', b3: 'w7', b5: 'bd', b6: 'bdt', am: 'bn', b7: 'bs', an: 'cpe', cc: 'cp', cd: 'cpx', ce: 'cpy', z: 'c', ap: 'ctr', aq: 'cb', ar: 'ccx', A: 'ccy', ad: 'cl', as: 'cr', cg: 'ct', ch: 'cptr', ci: 'ctxt', co: 'fcs', a9: 'focus-within', cp: 'fs', cq: 'g', aI: 'hbh', aJ: 'hc', bc: 'he', aK: 'hf', bd: 'hfp', cs: 'hv', cu: 'ic', cw: 'fr', au: 'lbl', cy: 'iml', cz: 'imlf', cA: 'imlp', cB: 'implw', cC: 'it', cD: 'i', bj: 'lnk', V: 'nb', bm: 'notxt', cI: 'ol', cK: 'or', M: 'oq', cP: 'oh', bp: 'pg', bq: 'p', cQ: 'ppe', cS: 'ui', q: 'r', cU: 'sb', cV: 'sbx', cW: 'sby', cX: 'sbt', cZ: 'e', c_: 'cap', c$: 'sev', c5: 'sk', n: 't', c8: 'tc', c9: 'w8', da: 'w2', db: 'w9', dc: 'tj', ax: 'tja', dd: 'tl', de: 'w3', df: 'w5', dg: 'w4', dh: 'tr', di: 'w6', dj: 'w1', dk: 'tun', bG: 'ts', P: 'clr', dp: 'u', aY: 'wc', bK: 'we', aZ: 'wf', bL: 'wfp', a_: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.bY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.z);
...
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.bY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bp);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.bY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bq);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.bY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.q);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.bY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cZ);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.t)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.c0.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.c0.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.q) + ('-' + ($elm$core$String$fromInt(pos.cf) + ('-' + ($elm$core$String$fromInt(pos.aa) + ('-' + $elm$core$String$fromInt(pos.U)))))));
		case 11:
	...
	[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cs, $mdgriffith$elm_ui$Internal$Style$classes.M)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.co, $mdgriffith$elm_ui$Internal$Style$classes.M)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bY) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.q) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bY) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bY) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.q) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bY) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ap) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {ao: closing, i: _List_Nil, D: _List_Nil, r: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								i: A2(
									$elm$core$List$cons,
									{ao: '\n}', i: _List_Nil, D: props, r: '@supports (' + (prop + (':' + (value + (') {' + parent.r))))},
									rendered.i)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.r + ('{' + (renderValues(rule.D) + (rule.ao + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.q) + (' / ' + ($elm$core$String$fromInt(position.q + position.U) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.cf) + (' / ' + ($elm$core$String$fromInt(position.cf + position.aa) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.q) + ('-' + ($elm$core$String$fromInt(position.cf) + ('-' + ($elm$core$String$fromInt(position.aa) + ('-' + $elm$core$String$fromInt(position.U)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.c_ + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.n + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.c_ + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.n)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {U: height / size, Y: size, bI: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.ca, adjustment.b$, adjustment.cj, adjustment.cF]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.bY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cZ))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bY, $mdgriffith$elm_ui$Internal$Style$classes.cZ, $mdgriffith$elm_ui$Internal$Style$classes.ap, $mdgriffith$elm_ui$Internal$Style$classes.A, $mdgriffith$elm_ui$Internal$Style$classes.bV])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bY, $mdgriffith$elm_ui$Internal$Style$classes.cZ, $mdgriffith$elm_ui$Internal$Style$classes.ap, $mdgriffith$elm_ui$Internal$Style$classes.A, $mdgriffith$elm_ui$Internal$Style$classes.bT])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bY, $mdgriffith$elm_ui$Internal$Style$classes.cZ, $mdgriffith$elm_ui$Internal$Style$classes.ap, $mdgriffith$elm_ui$Internal$Style$classes.bU])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bY, $mdgriffith$elm_ui$Internal$Style$classes.cZ, $mdgriffith$elm_ui$Internal$Style$classes.ap, $mdgriffith$elm_ui$Internal$Style$classes.bS])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.bY + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.n + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aJ)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.bY + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.n + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aZ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aK)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.cZ, $mdgriffith$elm_ui$Internal$Style$classes.bN]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.cZ, $mdgriffith$elm_ui$Internal$Style$classes.b1]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.cZ, $mdgriffith$elm_ui$Internal$Style$classes.cK]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.cZ, $mdgriffith$elm_ui$Internal$Style$classes.cI]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.cZ, $mdgriffith$elm_ui$Internal$Style$classes.cw]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.cZ, $mdgriffith$elm_ui$Internal$Style$classes.b0]));
						}
					}())
				]),
			_List_fromArray(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.bY + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.q + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ar + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.A + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.cX + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bm)))))),
						A2(
							$elm$core$List$cons,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{a2: 12, bi: 12, bA: 12, bF: 12}),
				$mdgriffith$elm_ui$Element$Font$size(16),
				$mdgriffith$elm_ui$Element$Font$bold,
				$mdgriffith$elm_ui$Element$mouseOver(
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Border$color(model.O)
					]))
			]),
		{
			cE: $mdgriffith$elm_ui$Element$text('Change colors'),
			cJ: $elm$core$Maybe$Just(0)
		});
};
...
var $author$project$Main$dogImage = A2(
	...
	{ck: 'A picture of my dog', c2: 'dog.png'});
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.cS, $mdgriffith$elm_ui$Internal$Style$classes.bY, $mdgriffith$elm_ui$Internal$Style$classes.cZ]))),
...
var $author$project$Main$viewTitle = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$bold,
				$mdgriffith$elm_ui$Element$Font$color(model.O),
		...
		$mdgriffith$elm_ui$Element$layoutWith,
		{
			cO: _List_fromArray(
				[
					...
					{
						b_: $elm$core$Maybe$Nothing,
						b4: $elm$core$Maybe$Just(model.av),
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{cx: $author$project$Main$darkColors, dq: $author$project$Main$update, dr: $author$project$Main$viewLayout});
